...
```
cd existing_repo
git remote add origin https://gitlab.com/yashasg/knitting-gauge-reconciler.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/yashasg/knitting-gauge-reconciler/-/settings/integrations)
